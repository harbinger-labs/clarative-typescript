...
import { Clarative, ClientOptions } from 'clarative';
...
function getTSDiagnostics(code: string): string[] {
  ...
  const codeWithImport = [
    ...
    functionSource.type === 'declaration' ?
      `async function run(${functionSource.client}: Clarative)`
    : `const run: (${functionSource.client}: Clarative) => Promise<unknown> =`,
    functionSource.code,
  ].join('\n');
...
const fuse = new Fuse(
  [
    ...
    'client.riskEvents.retrieve',
    'client.slas.getUptimeMetrics',
    'client.slas.list',
    'client.slas.listDataSources',
    'client.slas.listViolations',
    'client.slas.retrieve',
    'client.slas.retrieveViolation',
    'client.vendors.list',
    'client.vendors.retrieve',
  ],
