...
const EMBEDDED_METHODS: MethodEntry[] = [
  {
    ...
    httpMethod: 'get',
    summary: 'List all risk events with optional filters, sorted by most recent first',
    description: 'List all risk events with optional filters, sorted by most recent first',
  ...
  },
  {
    ...
    params: ['urn: string;'],
    response:
      "{ description: string; name: string; urn: string; vendor_urn: string; sla_details?: { measurement_period_unit: string; measurement_period_value: number; tiers: { availability_percentage: number; credit_unit: string; credit_value: number; }[]; sla_type?: 'UPTIME'; } | { measurement_period_unit: string; measurement_period_value: number; tiers: { availability_percentage: number; credit_unit: string; credit_value: number; per_unit: string; per_value: number; }[]; sla_type?: 'TIME_UNDER'; }; }",
    markdown:
      "## retrieve\n\n`client.slas.retrieve(urn: string): { description: string; name: string; urn: string; vendor_urn: string; sla_details?: object | object; }`\n\n**get** `/v1/slas/{urn}`\n\nFetch in-depth information about a single SLA\n\n### Parameters\n\n- `urn: string`\n\n### Returns\n\n- `{ description: string; name: string; urn: string; vendor_urn: string; sla_details?: { measurement_period_unit: string; measurement_period_value: number; tiers: { availability_percentage: number; credit_unit: string; credit_value: number; }[]; sla_type?: 'UPTIME'; } | { measurement_period_unit: string; measurement_period_value: number; tiers: { availability_percentage: number; credit_unit: string; credit_value: number; per_unit: string; per_value: number; }[]; sla_type?: 'TIME_UNDER'; }; }`\n\n  - `description: string`\n  - `name: string`\n  - `urn: string`\n  - `vendor_urn: string`\n  - `sla_details?: { measurement_period_unit: string; measurement_period_value: number; tiers: { availability_percentage: number; credit_unit: string; credit_value: number; }[]; sla_type?: 'UPTIME'; } | { measurement_period_unit: string; measurement_period_value: number; tiers: { availability_percentage: number; credit_unit: string; credit_value: number; per_unit: string; per_value: number; }[]; sla_type?: 'TIME_UNDER'; }`\n\n### Example\n\n```typescript\nimport Clarative from 'clarative';\n\nconst client = new Clarative();\n\nconst sla = await client.slas.retrieve('urn');\n\nconsole.log(sla);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    response: '{ created_at: string; description: string; name: string; urn: string; domains?: string[]; }[]',
    markdown:
      "## list\n\n`client.vendors.list(lifecycle_stage?: 'INITIAL_ASSESSMENT' | 'ONBOARDED'): { created_at: string; description: string; name: string; urn: string; domains?: string[]; }[]`\n\n**get** `/v1/vendors`\n\nList all vendors, sorted by name alphabetically (case-insensitive)\n\n### Parameters\n\n- `lifecycle_stage?: 'INITIAL_ASSESSMENT' | 'ONBOARDED'`\n  Filter vendors by lifecycle stage\n\n### Returns\n\n- `{ created_at: string; description: string; name: string; urn: string; domains?: string[]; }[]`\n\n### Example\n\n```typescript\nimport Clarative from 'clarative';\n\nconst client = new Clarative();\n\nconst vendors = await client.vendors.list();\n\nconsole.log(vendors);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    params: ['urn: string;'],
    response:
      "{ created_at: string; description: string; lifecycle_stage: 'INITIAL_ASSESSMENT' | 'ONBOARDED'; name: string; urn: string; domains?: string[]; metadata?: { name: string; type: 'TEXT' | 'SELECT' | 'MULTI_SELECT'; urn: string; value?: object; }[]; }",
    markdown:
      "## retrieve\n\n`client.vendors.retrieve(urn: string): { created_at: string; description: string; lifecycle_stage: 'INITIAL_ASSESSMENT' | 'ONBOARDED'; name: string; urn: string; domains?: string[]; metadata?: object[]; }`\n\n**get** `/v1/vendors/{urn}`\n\nFetch in-depth information about a single vendor\n\n### Parameters\n\n- `urn: string`\n\n### Returns\n\n- `{ created_at: string; description: string; lifecycle_stage: 'INITIAL_ASSESSMENT' | 'ONBOARDED'; name: string; urn: string; domains?: string[]; metadata?: { name: string; type: 'TEXT' | 'SELECT' | 'MULTI_SELECT'; urn: string; value?: object; }[]; }`\n\n  - `created_at: string`\n  - `description: string`\n  - `lifecycle_stage: 'INITIAL_ASSESSMENT' | 'ONBOARDED'`\n  - `name: string`\n  - `urn: string`\n  - `domains?: string[]`\n  - `metadata?: { name: string; type: 'TEXT' | 'SELECT' | 'MULTI_SELECT'; urn: string; value?: object; }[]`\n\n### Example\n\n```typescript\nimport Clarative from 'clarative';\n\nconst client = new Clarative();\n\nconst vendor = await client.vendors.retrieve('urn');\n\nconsole.log(vendor);\n```",
    perLanguage: {
      typescript: {
